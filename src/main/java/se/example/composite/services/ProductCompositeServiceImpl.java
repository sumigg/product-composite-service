...
import se.example.api.composite.product.ProductAggregate;
import se.example.api.composite.product.ProductCompositeService;
import se.example.api.composite.product.RecommendationSummary;
import se.example.api.composite.product.ReviewSummary;
import se.example.api.composite.product.ServiceAddresses;
...
public class ProductCompositeServiceImpl implements ProductCompositeService {
  ...
  public Mono<ProductAggregate> getProduct(int productId) {
    ...
    return Mono.zip(
        values -> createProductAggregate((SecurityContext) values[0], (Product) values[1], (List<Recommendation>) values[2],
